...
const DiscordRichPresence = require('../../')
...
function createWindow() {
  ...
  mainWindow.webContents.on('did-finish-load', () => {
    discordRichPresence.on('ready', (...args) => {
      console.log('discord emit ready')
      mainWindow.webContents.send('discord', 'ready', ...args)
    })
    discordRichPresence.on('disconnected', (...args) => {
      console.log('discord emit disconnected')
      mainWindow.webContents.send('discord', 'disconnected', ...args)
    })
    discordRichPresence.on('tick', (...args) => {
...
ipcMain.on('discord-update-presence', (event, presence) => {
  discordRichPresence.updatePresence(presence)
})
